...
import com.setvect.bokslstock2.backtest.vbs.model.VbsBacktestCondition
import com.setvect.bokslstock2.backtest.vbs.model.VbsConditionItem
import com.setvect.bokslstock2.backtest.vbs.service.VbsBacktestService
...
//        val range = DateRange(DateUtil.getLocalDateTime("2018-01-01T00:00:00"), DateUtil.getLocalDateTime("2023-05-12T00:00:00"))
        ...
        val dir = File("./backtest-result/vbs-trade-report")
        dir.mkdirs()
        val reportFile = File(dir, "vbs_trade_${range.fromDate}~${range.toDate}.xlsx")
