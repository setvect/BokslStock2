...
import com.setvect.bokslstock2.backtest.mabs.model.MabsBacktestCondition
import com.setvect.bokslstock2.backtest.mabs.service.MabsBacktestService
...
class MabsBacktest {
    ...
    fun 일회성_백테스팅_리포트_만듦() {
        ...
        val dir = File("./backtest-result/mabs-trade-report")
        dir.mkdirs()
        val reportFile = File(dir, "mbas_trade_${range.fromDate}~${range.toDate}.xlsx")
